 ...
 *
 *
 * @package    propel.generator.User.Base
 */
abstract class User implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\User\\Map\\UserTableMap';
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\User\User The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \User\User (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \User\User Clone of current object.
     * @throws PropelException
     */
